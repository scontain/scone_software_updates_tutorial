...
sconectl apply -f service$ALTERNATIVE.yaml $verbose $debug
...
sconectl apply -f mesh$ALTERNATIVE.yaml --release "$RELEASE" --release-version $ALTERNATIVE $verbose $debug
